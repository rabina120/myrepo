<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true"
    CodeBehind="ForgotUsername.aspx.cs" Inherits="Openend_SIP.Modules.MainPage.ForgotUsername" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <form id ="form1" runat="server">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <!-- Tabs Titles -->
            <h3 style="margin-top: 10px; font-family: -webkit-body; color: #22429a;">Forgot Username</h3>
            <hr />
            <!-- Icon -->
            ...
            <form>
                ...
                <input type="text" id="txEmail" class="fadeIn third" data-bind="value: Email"
                    name="Email" placeholder="Email" name="Email" placeholder="Email" /><br />
                <input type="submit" value="submit" data-bind="click: GetUsername" class="fadeIn fourth" />
            </form>
            <div id="lock-modal">
            </div>
    ...
    <script src="../../Scripts/MainPage/ForgotUsername.js?v=0.1" type="text/javascript"></script>
</asp:Content>
