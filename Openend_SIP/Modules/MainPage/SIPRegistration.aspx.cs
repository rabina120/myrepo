...
{
    public partial class SIPRegistration : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var PayAppIdSIPRegistrations = CredentialManager.PayAppIdSIPRegistration;
            PayAppIdSIPRegistration.Value = PayAppIdSIPRegistrations;

            var SIPRegistrationURLs = CredentialManager.SIPRegistrationURL;
            SIPRegistrationURL.Value = SIPRegistrationURLs;
        }
    }
}