...
namespace Openend_SIP.Modules.SIPHandling
{
    public partial class SIPPayment : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var PayAppIdLoginSIPPayments = CredentialManager.PayAppIdLoginSIPPayment;
            PayAppIdLoginSIPPayment.Value = PayAppIdLoginSIPPayments;

            var LoginSIPPaymentURLs = CredentialManager.LoginSIPPaymentURL;
            LoginSIPPaymentURL.Value = LoginSIPPaymentURLs;
        }
    }
}