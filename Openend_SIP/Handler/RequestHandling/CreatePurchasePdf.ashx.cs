...
{
    /// <summary>
    /// Summary description for CreatePurchasePdf
    /// </summary>
    public class CreatePurchasePdf : BaseHandler
    {
            ...
            string fileName = "";
              ...
              // string msg = sm.ReadFile(null);
                try
                {
                    ...
                    //fileName = "/Purchase Entry Report -" + System.DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") + ".pdf";
                    fileName = guid + ".pdf";
                    ...
                    cell1 = new PdfPCell(new Phrase("Trans. No.", fntHeader)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER };
                    // cell1.BackgroundColor = BaseColor.WHITE;
