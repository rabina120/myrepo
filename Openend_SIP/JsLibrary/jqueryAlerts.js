...
(function ($) {
    ...
    $.alerts = {
        ...
        failure: function (message, title, callback) {
            if (title == null) title = 'Failure';
            $.alerts._show(title, message, null, 'failure', function (result) {
                if (callback) callback(result);
            });
        },
    ...
    // Shortuct functions
    msg = function (message,type,title, callback) {
        ...
        switch (type) {
            ...
            case 'WARNING':
                ...
                break;
            case 'FAILURE':
                $.alerts.failure(message, title, callback);               
                break;
            default:
                $.alerts.alert(message, title, callback);
        }
